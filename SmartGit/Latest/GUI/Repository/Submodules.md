...
A submodule usually shows up in SmartGit's UI at the same time in the [*Repositories View*](../Repository-View.md) and in the **Files** view. Available Operations on the main menu will depend on whether the **Repositories** view or the **Files** is in focus:
